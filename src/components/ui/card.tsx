...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-white/60 bg-card/90 text-card-foreground shadow-[0_24px_55px_-36px_hsl(var(--primary)/0.28)] backdrop-blur-sm dark:border-white/[0.08]",
      className
    )}
    {...props}
  />
