...
exports.getSupabaseServiceRoleConfig = getSupabaseServiceRoleConfig;
...
function getSupabaseServerConfig() {
    if (!supabaseUrl || !supabaseAnonKey) {
        throw new Error("Supabase server client not configured. Set SUPABASE_URL/NEXT_PUBLIC_SUPABASE_URL and SUPABASE_ANON_KEY/NEXT_PUBLIC_SUPABASE_ANON_KEY.");
    }
    return {
        url: supabaseUrl,
